...
export function ResetPassword() {
  ...
  const {mutateAsync, isPending, isSuccess, data, isError, error} = useResetPassword()
    ...
    <section className={styles.resetPassword}>
      <Card>
        ...
        <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
          <FormField id="new_password" label="Nueva contraseña" type="password" registration={register('new_password')} error={errors.new_password?.message}/>
        ...
        <Link className={styles.back} to={PATHS.LOGIN}>Volver la inicio de sesión</Link>
      </Card>
    </section>
  )
}
