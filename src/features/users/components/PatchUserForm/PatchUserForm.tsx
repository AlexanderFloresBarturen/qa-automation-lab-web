...
import type { PatchUserFormData, PatchUserRequest, UserDetailResponse } from '@/features/users'
  ...
  return (
    <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <FormField
        ...
        label="Edad"
        type="number"
        registration={register('age', { valueAsNumber: true, onChange: () => setFormError(null)})}
